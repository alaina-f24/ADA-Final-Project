...
pacman::p_load(tidyverse, readr, table1, DiagrammeR, rsvg, survival, ggfortify, survminer, ggplot2, lmtest, foreign, naniar)
...
```{r}
##(this is demo/lab code, adjust as needed)

RMST does not like 0 as a survival time. For those with 0 months survival time, change to 0.5 months
breast2 <- breast2 %>%
  mutate(survmo2 = case_when(survmo == 0 ~ 0.5,
                              survmo > 0 ~ survmo))
summary(breast2$survmo2)
