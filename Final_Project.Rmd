...
pacman::p_load(tidyverse, readr, table1, DiagrammeR, car, rsvg, survival, ggfortify, survminer, ggplot2, lmtest, foreign, naniar, survRM2, haven, magrittr, mlr)
...
cerv <- replace_with_na(cerv, replace = list(
                               stage = c("Unknown/unstaged", "In situ", "Blank(s)"), #set "In situ" as NA because only 7 observations (0%) in entire dataset 
...
#relevel stage variable so Localized is reference
cerv$stage <- factor(cerv$stage,
...
#number of cases = 44,428
#check percentage of cases removed = 18.35%
...
#number of cases = 49,897
#check percentage of cases removed = 8.30%
...
figure1 <- grViz(diagram = "digraph flowchart{ 
      ...
      [1]: 'Data received from SEER database, women diagnosed with cervical cancer in 2000-2021 \\n from 22 SEER Registries in the United States, n = 120,618'
      [2]: 'Excluding 65,661 individuals outside of the timeframe of interest 2010-2019, n = 54,957'
      [3]: 'Excluding 542 individuals under the age of 18, n = 54,415'
      [4]: 'Excluding 703 individuals with missing data on Race/Ethnicity, Vital Status, and Survival Time, n = 53,712'
      [5]: 'Excluding 4,511 individuals with missing data on Age at Diagnosis, \\n Year of Diagnosis, Income, Rural/Urban Status, and Stage, n = 49,897'
      ")
...
##initial table
table1( ~ surv_months + cause_spec_death + age + year_dx + stage + rural_urban + income_cat| race_eth, overall = "Total", rowlabelhead = "Variable", cerv_3)
...
km_plot <- autoplot(cerv.surv) + labs(x="Months", y="Proportion Surviving", title="KM survival plots for Cervical Cancer by Race/Ethnicity") 
...
-   Those who were NH Black had a 1.41 (95% CI 1.35 - 1.48) times higher hazard of death from cervical cancer than those who were NH White.

-   Those who were NH Asian or Pacific Islander had a 0.91 (95% CI 0.85-0.97) times hazard of death from cervical cancer than those who were NH White.

-   Those who were Hispanic (all races) had a 0.89 (95% CI 0.86-0.93) times hazard of death from cervical cancer than those who were NH White.
...
#adjusting for age, year at diagnosis, stage, income, rural/urban
race.adj <- coxph(Surv(surv_months, vstat) ~ race_eth + age + year_dx + stage + income_cat + rural_urban, cerv_3, ties = "efron")
summary(race.adj)
...
-   After adjusting for age at diagnosis, year of diagnosis, stage, income level, and residential location, those who were NH Black had a 1.20 (95% CI 1.14 - 1.25) times higher hazard of death from cervical cancer than those who were NH White.

-   After adjusting for age at diagnosis, year of diagnosis, stage, income level, and residential location, those who were NH Asian or Pacific Islander had a 0.88 (95% CI 0.83 - 0.94) times hazard of death from cervical cancer than those who were NH White.

-   After adjusting for age at diagnosis, year of diagnosis, stage, income level, and residential location, those who were Hispanic(all races) had a 0.91 (95% CI 0.88 - 0.95) times hazard of death from cervical cancer than those who were NH White.

-   After adjusting for age at diagnosis, year of diagnosis, stage, income level, and residential location, those who were NH American Indian/Alaska Native did not have a significant difference (p\>0.05) in hazard of death from cervical cancer than those who were NH White.
...
### Check Assumptions (multicolinearity and linearity of continuous variables)
...
##p-value for interaction term is <0.05, indicating the linearity assumption is NOT met for age... Really close and want to avoid making categorical variable, check with histogram next
...
age_plot <- ggplot(cerv_3, aes(x = age)) +
  geom_histogram(binwidth = 1, fill = "steelblue", color = "white") +
  labs(title = "Distribution of Age at Diagnosis",
       x = "Age at Diagnosis", y = "Number of Cases") +
  theme_minimal()

##this is a little skewed but mostly has normal distribution, going to keep as a continuous variable


#visualize distribution of year_dx variable
year_plot <- ggplot(cerv_3, aes(x = year_dx)) +
  geom_histogram(binwidth = 1, fill = "steelblue", color = "white") +
...
#run adjusted Cox PH with year_cat
race.adj.mod <- coxph(Surv(surv_months, vstat) ~ race_eth + age + year_cat + stage + income_cat + rural_urban, cerv_3, ties = "efron")
...
-   After adjusting for age at diagnosis, year of diagnosis, stage, income level, and residential location, those who were NH Black had a 1.19 (95% CI 1.14 - 1.25) times higher hazard of death from cervical cancer than those who were NH White.

-   After adjusting for age at diagnosis, year of diagnosis, income level, and residential location, those who were NH Asian or Pacific Islander had a 0.88 (95% CI 0.83 - 0.94) times hazard of death from cervical cancer than those who were NH White.

-   After adjusting for age at diagnosis, year of diagnosis, income level, and residential location, those who were Hispanic(all races) had a 0.92 (95% CI 0.88 - 0.95) times hazard of death from cervical cancer than those who were NH White.
...
-   The mean survival time for patients who were NH White was 47.6 months, NH Black was 43.4 months, NH Asian or Pacific Islander was 49.2 months, NH American Indian/Alaska Native was 48.5 months, and Hispanic (All Races) was 49.0 months respectively when following the patients for 60 months (5 years).

**Between-group contrast**

-   The differences in RMST between NH Black vs. NH White was -4.2 months, NH Asian vs. NH White was 1.6 months, NH American Indian vs NH White was 0.9 months, and Hispanic vs. NH White was 1.4 months, respectively.

    -   This indicates that the survival time after diagnosis for NH Black patients was 4.2 months shorter than NH White patients on average, when following the patients for 60 months.

    -   Also indicates that the survival time after diagnosis for NH Asian or Pacific Islander, NH American Indian/Alaska Native, and Hispanic (All Races) patients were 1.6 months, 0.9 months, and 1.4 months longer than NH White patients respectively, when following the patients for 60 months.
...
cerv_4 <- createDummyFeatures(cerv_4, cols = "stage")
...
rmst.black.adj <- rmst2(cerv_black$surv_months2, cerv_black$vstat, cerv_black$race_bin, tau= 60, covariates = cerv_black %>% select(age, year_cat.2011, year_cat.2012, year_cat.2013, year_cat.2014, year_cat.2015, year_cat.2016, year_cat.2017, year_cat.2018, year_cat.2019, income_cat.1, income_cat.2, income_cat.3, rural_urban.urban.med, rural_urban.urban.small, rural_urban.rural.big, rural_urban.rural.small, stage.Regional, stage.Distant))

###using the year_dx.2010, highest income level (income_cat.1), urban largest population (rural_urban.urban.big), least severe cancer stage (stage.Localized) as reference levels
...
rmst.api.adj <- rmst2(cerv_api$surv_months2, cerv_api$vstat, cerv_api$race_bin, tau= 60, covariates = cerv_api %>% select(age, year_cat.2011, year_cat.2012, year_cat.2013, year_cat.2014, year_cat.2015, year_cat.2016, year_cat.2017, year_cat.2018, year_cat.2019, income_cat.1, income_cat.2, income_cat.3, rural_urban.urban.med, rural_urban.urban.small, rural_urban.rural.big, rural_urban.rural.small, stage.Regional, stage.Distant))
...
##run the adjusted RMST for NH White vs NH AIAN
rmst.his.adj <- rmst2(cerv_his$surv_months2, cerv_his$vstat, cerv_his$race_bin, tau= 60, covariates = cerv_his %>% select(age, year_cat.2011, year_cat.2012, year_cat.2013, year_cat.2014, year_cat.2015, year_cat.2016, year_cat.2017, year_cat.2018, year_cat.2019, income_cat.1, income_cat.2, income_cat.3, rural_urban.urban.med, rural_urban.urban.small, rural_urban.rural.big, rural_urban.rural.small, stage.Regional, stage.Distant))
...
After adjustment for age at diagnosis, year of diagnosis, income, stage, and rural/urban status...

-   The differences in RMST between NH Black vs. NH White was -1.636 months, NH Asian vs. NH White was 1.275 months, NH American Indian vs NH White was -0.514 months, and Hispanic vs. NH White was 0.833 months, respectively.

This indicates that...

-   The survival time after diagnosis for NH Black patients was 1.636 months shorter than NH White patients on average, when following the patients for 60 months (p\<0.05).

-   The survival time after diagnosis for NH Asian or Pacific Islander patients was 1.2.75 months longer than NH White patients on average, when following the patients for 60 months (p\<0.05).

-   The survival time after diagnosis for NH American Indian/Alaska Native patients was 0.514 months shorter than NH White patients on average, but was not significant (p=0.588) when following the patients for 60 months. (non-significant likely due to small sample size)

-   The survival time after diagnosis for Hispanic (All Races) patients was 0.833 months longer than NH White patients on average, when following the patients for 60 months (p\<0.05).
